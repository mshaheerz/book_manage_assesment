...
function AddBookModal({ setShowModal }) {
    ...
    function submitForm(){
        setShowModal(false)
        dispatch(books([{title:title,body:description,author:author},...booksDetails,]))
                        ...
                        <div className="relative p-6 flex-auto">
                            ...
                            <form>
                                ...
                                <div className="mb-6">
                                    ...
                                    <input type="text" onChange={(e)=>setAuthor(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                                </div>
                                <div className="mb-6">
